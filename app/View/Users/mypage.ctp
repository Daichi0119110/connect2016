...
<div class="clearfix scroll-fix" id="about">
  <div class="page-title"><?php echo $user['name']; ?> </div><div class="page-sub-title">--- <?php echo $university['university']?>へ留学 ---</div><a class="favorite-btn fa fa-floppy-o" href="<?php echo SITE_URL;?>users/edit"> 編集</a></div>
