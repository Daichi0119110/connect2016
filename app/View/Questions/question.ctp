...
<div class="" id="about">
  <h2 style="display:inline">ゲント大学に関するQ&A</h2>&emsp;
  <a href=""><h4 style="display:inline">ゲント大学のページに戻る</h4></a>
</div>

<!-- 質問フォーム始 -->
          <div class="row centered top-margin-l">
...
<!-- 閲覧数が多い質問 -->
      <div id="mostviewed" class="row">
              <h2>閲覧数の多い質問</h2>
                <!--質問１つの塊-->
                <div id="mostviewed-sub-1" class="question-box">
                  <div class="row">
                ...
                <!--質問１つの塊-->
                <div id="mostviewed-sub-2" class="question-box">
                  <div class="row">
                    <h3 class="question-title">Question</h3>
                    <div class="col-md-2">
                     <a href="">
...
<!-- 新着の質問 -->
      <div id="new" class="row">
              <h2>新着の質問</h2>
                <!--質問１つの塊-->
                <div id="new-sub-2" class="question-box">
                  <div class="row">
                    <h3 class="question-title">Question</h3>
                    <div class="col-md-2">
                     <a href="">
                  ...
                  <!-- 回答フォーム始 -->
                            <div class="form-group top-margin-s">
                              ...
                              <span class="input-group-btn">
                                <button class="btn btn-default form-btn-l" type="button">回答する</button>
                              </span>
                            </div>
                  <!-- 回答フォーム終 -->
                </div> <!-- questionbox -->
